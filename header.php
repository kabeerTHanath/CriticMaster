...
<nav id="navbar" class="navbar navbar-expand-md d-flex navbar-light">
  ...
  <div class="col-sm-12 col-md-4 d-flex px-0">
  ...
  <div class="col-sm-12 col-md-8 mt-2 px-0" style="background: #ccc">
   <?php dynamic_sidebar( 'header_ad' ); ?>
  </div>



    <div class="collapse navbar-collapse bg-dark align-self-end mt-3 mb-2 pl-2" id="navbarDropdown">
      <?php
        wp_nav_menu( array(
    ...
    <?php get_template_part('parts/breaking_scroll');?>
