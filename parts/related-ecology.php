...
<section id="related-two" class="related">
      <div class="row">
        <div class="col-sm-6 mt-4">
                ...
                <div class="card mb-4">
                  <div class="card-header" style="text-transform: uppercase;color: #000;">
                       <a href="https://www.thecritic.in/category/ecology/">ECOLOGY</a>
                  </div>
                ...
                <?php else : ?>
                  ...
                  <div id="second" class="row no-gutters bg-light mb-1 mt-1">
                     ...
                     <div class="col-sm-8 col-8 border"><div class="card-body p-2">  <h6><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h6>
        ...
        <div class="col-sm-6 mt-4 rlp">
                ...
                <div class="card mb-4">
                  <div class="card-header" style="text-transform: uppercase;color: #000;">
                      <a href="https://www.thecritic.in/category/international/">INTERNATIONAL</a>
                  </div>
                ...
                <div id="third" class="row no-gutters bg-light mb-1 mt-1">
                     ...
                     <div class="col-8 border"><div class="card-body p-2">  <h6><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h6>
