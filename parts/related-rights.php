...
<div class="card-header" style="text-transform: uppercase;color: #000"><a href="https://www.thecritic.in/category/human-rights/">HUMAN RIGHTS</a></div>
      ...
      <div class="row">        
              ...
              <div class="col-sm-6 rlp">
                ...
                <?php else : ?>
                  ...
                  <div class="row no-gutters bg-light mb-1 mt-3">
                      <div class="col-sm-4 col-4">
                        <?php the_post_thumbnail('thumb')?>   
                      </div>

                      <div class="col-sm-8 col-8 pl-2 border">
