...
if ( ! function_exists('b4st_setup') ) {
	function b4st_setup() {
		...
		update_option('thumbnail_size_w', 150); /* internal max-width of col-3 188*/
		update_option( 'thumbnail_size_h', 150 );
		update_option('small_size_w', 450); /* internal max-width of col-4  236*/
		update_option('medium_size_w', 650); /* internal max-width of col-8 340*/
		update_option('large_size_w', 900); /* internal max-width of col-12   471 */
