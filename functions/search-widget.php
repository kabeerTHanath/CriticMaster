...
if ( ! function_exists('b4st_search_form') ) {
  ...
  function b4st_search_form( $form ) {
    $form = '<div class="d-sm-none d-md-block"><form class="form-inline mb-3" role="search" method="get" id="searchform" action="' . home_url('/') . '" >
      <input class="form-control col-md-10 mr-sm-2" type="text" value="' . get_search_query() . '" placeholder="' . esc_attr_x('Search', 'b4st') . '..." name="s" id="s" />
